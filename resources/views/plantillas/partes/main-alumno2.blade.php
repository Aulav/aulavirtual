        ...
        <div class="collection ">
          ...
          <p class="user-name">Felipe Guzman</p>
          ...
          <a href="admins.html" class="collection-item"><i class="material-icons">group</i>Enviar mensajes</a>
              ...
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    <li><a href="profile_institucion.html" class="collection-item"><i class="material-icons">account_box</i>Asistencia</a></li>
                    <li><a href="profile_institucion.html" class="collection-item"><i class="material-icons">account_box</i>Entregas</a></li>
                    <li><a href="profile_institucion.html" class="collection-item"><i class="material-icons">account_box</i>Discusiones</a></li>
                    <li><a href="profile_institucion.html" class="collection-item"><i class="material-icons">account_box</i>Pruebas</a></li>
                    <li><a href="profile_institucion.html" class="collection-item"><i class="material-icons">account_box</i>Comentarios</a></li>
                  </ul>
                </div>
              </li>
            </ul>
