        ...
        <div class="collection ">
          ...
          <a href="{{asset('/docente/inicio')}}" class="collection-item active"><i class="material-icons">home</i>Inicio</a>
          <a href="{{ asset('/docente/calificaciones')}}" class="collection-item "><i class="material-icons">done_all</i>Calificaciones</a>
              ...
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li><a href="#!" class="collection-item"><i class="material-icons">input</i>Salir</a></li>
                  </ul>
                </div>
              </li>
            </ul>
