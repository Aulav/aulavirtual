<!--inithial menu-->
    ...
    <ul id="dropdown1" class="dropdown-content ">
        <li><a href="{{ asset('docente/profile')}}"><i class="material-icons ">person</i>Perfíl</a></li>
        <li class="divider"></li>
    ...
    <ul id="dropdown1" class="dropdown-content">
        <li><a href="{{ asset('docente/profile')}}"><i class="material-icons">person</i>Perfil</a></li>
        <li class="divider"></li>
        @if (Session::get('rol') == 1)
            <li><a href="{{ asset('docente/logout') }}"><i class="material-icons">input</i>Salir</a></li>
        @elseif ( Session::get('rol') == 2 )
